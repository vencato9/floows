...
function Projects() {
  ...
  return (
    <div className="App">
      ...
      >
        <path
          d="M185.936 209.889C-498.967 93.183 938.994 -244.026 938.994 308.974C938.994 420.575 917 478.822 857.778 486.474C153.494 577.474 1042.06 355.771 185.936 209.889Z"
          stroke="#EEEEEE"
        />
      </svg>
      ...
      <div className="banana-image1">
        ...
        <div className="banana-text-image">
          ...
          <h2 className="Portfolio">
            {" "}
            Avant Première <span className="portfoliow">2021</span>
          </h2>
